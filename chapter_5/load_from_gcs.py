# Load BigQuery Python GCP Library
...
if (local):
  ...
  print ("Loading {} file {} into dataset {} as table {}...".format (("local" if local else "GCS"),(location if local else gcs_uri), dataset_name, table_name))
